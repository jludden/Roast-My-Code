...
const About = () => {
    return (
        <div>
            ...
            <p>
                Formerly a back-end focused developer, I have recently gotten more involved in front-end and full-stack development. Feel free to check out my developer portfolio here:
                <a href="http://jasonludden.dev/">jasonludden.dev</a>
                And Github profile:
                <a
                    title="Github"
